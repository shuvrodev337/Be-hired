...
const AppliedJob = ({ appliedJob }) => {
  ...
  return (
    <div className="flex justify-between p-3 items-center border-2 border-slate-100 rounded-lg">
      ...
      <Link to={`/job/${id}`}>
        <button className="font-medium md:mb-0  px-9 py-2 md:py-2 rounded-md text-base text-white bg-purple-500 ">View Details</button>
       </Link>
    </div>
  );
};
